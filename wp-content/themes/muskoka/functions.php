...
function create_main_slider() {
    register_post_type( 'main_slider',
        array(
            'labels' => array(
                'name' => 'Slider',
                'singular_name' => 'main_slider',
                'add_new' => 'Add New',
                'add_new_item' => 'Add New Slide',
                'edit' => 'Edit',
                'edit_item' => 'Edit New Slide ',
                'new_item' => 'New New Slide',
                'view' => 'View',
                'view_item' => 'View  Slider',
                'search_items' => 'Search  Slider',
                'not_found' => 'No  Slider Found',
                'not_found_in_trash' => 'No Slider found in Trash',
                'parent' => 'Parent Main Slider'
            ),
...
function create_main_slider_taxonomies() {
    $labels = array(
    ...
    register_taxonomy( 'main_slider_categories', array( 'main_slider' ), $args );
}
add_action( 'init', 'create_main_slider_taxonomies', 0 );
add_image_size( 'home_slider_image', 1500,512, true );
/* testimonials */
...
function create_testimonials_taxonomies() {
    ...
    $args = array(
        ...
        'show_admin_column' => true,
        'query_var'         => true, 
        'rewrite'           => array( 'slug' => 'categories_testimonials' ),
    );
...
add_image_size( 'our_team_image', 225,217, true );
add_image_size( 'our_team_about_image', 250,213, true );
add_image_size( 'banner_image', 1500,296, true );
add_image_size( 'about_image', 250,213, true );
...
function create_properties_taxonomies() {
    ...
    register_taxonomy( 'properties_categories', array( 'properties' ), $args );
}
add_action( 'init', 'create_properties_taxonomies', 0 );
add_image_size( 'properties_image', 549,358, true );
add_image_size( 'listing_image', 345,334, true );
add_image_size( 'single_image', 586,476, true );
add_image_size( 'abouts_image', 250,213, true );
/*pagination */
